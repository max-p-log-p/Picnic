...
all: $(SHA3LIB) $(SOURCES) $(PICNIC_LIB) $(EXECUTABLE_EXAMPLE) $(EXECUTABLE_TESTVECTORS) $(EXECUTABLE_UNITTEST) $(EXECUTABLE_KATSTEST) $(PQTR) $(EXECUTABLE_TREETEST)
...
$(PQTR): $(PQTR).c $(PICNIC_LIB)
	    $(CC) $(@).c $(NISTKATFLAGS) $(CFLAGS) $(PICNIC_LIB) -o $@ $(LDFLAGS)
